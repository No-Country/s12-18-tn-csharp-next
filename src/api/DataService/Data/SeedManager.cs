...
public static class SeedManager
{
    ...
    private static async Task SeedEvents(IServiceProvider services)
    {
        ...
        eventos.Add(new Event
        {
            ...
            Description = "Ayuda a las v�ctimas del reciente terremoto en Nepal contribuyendo a nuestro fondo de ayuda.",
            Collect_Goal = 100000,
            Collected = 0,
            ...
            Complaints = new List<Complaint>
                {
                    new Complaint
                    {
                        ...
                        Title = "Problema con la Recaudaci�n de Fondos",
                        Description = "Me gustar�a informar sobre un problema relacionado con la recaudaci�n de fondos para el evento de ayuda por terremoto en Nepal.",
                        Media = new List<Media>
                        {
        ...
        eventos.Add(new Event
        {
            ...
            Description = "Ay�danos a proporcionar ayuda a quienes se han visto afectados por los incendios forestales en California.",
            Collect_Goal = 120000,
            Collected = 0,
            Media = new List<Media>
            {
